...
class UpdateRequest extends WebRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:255',  Rule::unique('courses','slug')->ignore($this->course->ID), 'english_only'],
            'duration' => ['required', 'integer', 'min:1','max:86400'], // 10 Year
            'type' => ['required', Rule::in(CourseTypes::values())],
            'price' => ['nullable', 'numeric', 'min:0','max:2000000000000'], //200'000'000'000
