...
@section('pageTitle', st('Add season'))

@section('content')
    {!! html()->form('POST', route('admin.cg.movieSeason.store', $movie->ID))->open() !!}
        ...
        <div class="card-body">
            <div class="text-right mt-2">
                <div class="btn-group gap-2" role="group">
                    ...
                    {{ html()->a(route('admin.cg.movieSeason.list', ['movieID' => $movie->ID]), st('Back'))->class('btn btn-secondary') }}
                </div>
            </div>
        </div>
    </div>
