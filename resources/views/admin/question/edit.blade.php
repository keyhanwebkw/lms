...
@section('content')
    {!! html()->form('POST', route('admin.question.update',$question->ID))->acceptsFiles()->open() !!}
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->select('questionDifficultyLevel', $difficultyLevel, $question->questionDifficultyLevel)
                            ->class('form-select')}}
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->number('timeLimit',$question->timeLimit)
                            ->class('form-control')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->number('score', $question->score)
                            ->class('form-control')
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->number('sortOrder', $question->sortOrder)
                            ->class('form-control')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-body">
                <div class="mb-3">
                    {{ html()->textarea('question', $question->question)
                        ->class('form-control')
            ...
            <div class="mb-3">
                <div class="form-group">
                    <x-subsystem::file-preview name="content" label="{{st('content')}} ({{st('ifExists')}})"
                                               filePath="{{route('storage.download',
                        ['type' => 'original','SID' => $contentPath ?? '-',])}}"/>
                </div>
            </div>
        </div>
    </div>
